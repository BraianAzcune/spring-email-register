...
import com.usuarioEmail.demo.email.EmailSender;
...
public class RegistrationService {
  ...
  public String register(RegistrationRequest request) {
    ...
    String token = appUserServices.signUpUser(new AppUser(
        request.getEmail(),
        request.getPassword(),
        AppUserRole.USER));
  ...
  public String confirmToken(String token) {
    ...
    var expiredAt = confirmationToken.getExpiryDate();
    if (expiredAt.isBefore(LocalDateTime.now())) {
      throw new IllegalStateException("token expired");
    }

    confirmationTokenService.setConfirmed(confirmationToken);

    appUserServices.enableAppUser(confirmationToken.getAppUser().getEmail());
